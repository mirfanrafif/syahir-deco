@extends('templates.home') @section('title', 'Detail Barang')
@section('content')
<section class="section bg-gray">
          ...
          <div class="product-meta">
            <ul class="list-inline">
              <li class="list-inline-item">
                <i class="fa fa-folder-open-o"></i> Kategori<a href="">{{$barang->kategori}}</a>
              </li>
              <li class="list-inline-item">
                <i class="fa fa-location-arrow"></i> Kategori
                Acara<a href="">{{$barang->kategori_acara}}</a>
              </li>
            </ul>
          </div>
        ...
        <div class="sidebar">
          ...
          <div class="widget disclaimer">
            ...
            <form action="" method="dialog">
              ...
              <input type="submit" value="Cek" class="btn btn-primary" id="cekKetersediaan" />
          ...
          <div class="widget coupon text-center">
            <!-- Coupon description -->
            <p>Tertarik dengan Produk Kami?</p>
            <!-- Submii button -->
  ...
  <script>
    $(document).ready(function () {
          ...
          $("#cekKetersediaan").click(function () {
            {
            var cektanggal = $("#cektanggal").val();

            console.log(cektanggal);
            $.get("/api/sewa/" + {{$barang->idbarang}}, {"cektanggal" : cektanggal}).done(function (data) {
              console.log(data)
